...
import { CircleBackslashIcon, CrossCircledIcon, ImageIcon, UploadIcon } from "@radix-ui/react-icons";
                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="col-span-full">
                    <FormItem>
                      ...
                      <div
                        className="items-center divide-x gap-3 justify-center w-full border rounded-lg p-3 grid grid-cols-2"
                      >
                        <div className="relative w-full py-12 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-primary-foreground hover:bg-gray-100 dark:hover:border-gray-500 dark:hover:bg-primary-foreground/70" {...getRootProps()}>
                          <label
                            ...
                            <div className=" text-center">
                              ...
                              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                <span className="font-semibold">Drag your images here</span>
                              </p>
